...
public class QCMBuilder
{
	...
	/*
	 * public void genererQuestionnaire(String nomRessource, List<String>
	 * nomsNotions) { try {
	 * 
	 * // Create directories new File("../questionnaire/css").mkdirs(); new
	 * File("../questionnaire/images").mkdirs(); new
	 * File("../questionnaire/pages").mkdirs(); new
	 * File("../questionnaire/script").mkdirs();
	 * 
	 ...
	 * String sIndex = header + // "<body>\n" + // "\t\n" + //
	 * "\t<h1 class=\"evaluation-title\">Questionnaire "+ nomRessource
	 * +"</h1>\n" + // "\n" + // "\t<div class=\"informations\">\n" + //
	 * "\t\t<p class=\"estimated-time\">Temps estimé : <span class=\"estimated-time-data\">20h</span></p>\n"
	 * + // "\n" + //
	 * "\t\t<p class=\"resource\">Ressources concernée : <span class=\"resource-data\">"
	 * +nomRessource+"</span></p>\n" + // "\n" + //
	 * "\t\t<p class=\"notions-title\">Notion abordées :</p>\n" + //
	 * "\t\t<ul class=\"notions-list\">\n"; //
	 * 
	 * for (String nom : nomsNotions) sIndex+
	 * ="\t\t\t<li class=\"notion-item\"><span class=\"notions-item-data\">" +
	 * nom +"</span></li>\n"; //
	 * 
	 * sIndex+="\t\t</ul>\n" + // "\n" + //
	 ...
	 * + // "\t\t\t<li class=\"difficulty-item easy\"> } Facile : <span
	 * class=\"difficulty-item-data\">3</span></li>\n" + //
	 ...
	 * + // "\t</div>\n" + // "</body>\n" + // "</html>";
	 * finWriter.println(sFin); finWriter.close();
	 * 
	 * 
	 ...
	 * 
	 * 
	 * // Create and write to CSS files PrintWriter cssWriter = new
	 * PrintWriter("../questionnaire/css/styles.css");
	 * cssWriter.println("/* TODO "); cssWriter.close();
	 * 
	 * // Create and write to image files new
	 * File("../questionnaire/images/cheval1.jpg").createNewFile(); new
	 * File("../questionnaire/images/cheval.jpg").createNewFile(); new
	 * File("../questionnaire/images/drapeau_france.png").createNewFile();
	 * 
	 * // Create and write to HTML files PrintWriter question1Writer = new
	 * PrintWriter("../questionnaire/pages/question1.html"); String sQuestion1 =
	 * headerQuestion + // "<body value=\"1\">\n" + //
	 ...
	 * "\t\t\t\t}\n" + // "\t\t\t});\n" + // "\t\t});\n" + // "\t</script>\n" +
	 * // "</body>\n" + // "</html>"; question1Writer.println(sQuestion1);
	 * question1Writer.close();
	 * 
	 * PrintWriter question2Writer = new
	 * PrintWriter("../questionnaire/pages/question2.html"); String sQuestion2 =
	 * headerQuestion + // "<body value=\"2\">\n" + //
	 ...
	 * "\t\t\t\t\tprogressFill.style.width = `${widthPercentage}%`;\n" + //
	 * "\t\t\t\t}\n" + // "\t\t\t});\n" + // "\t\t});\n" + // "\t</script>\n" +
	 * // "</body>\n" + // "</html>"; question2Writer.println(sQuestion2);
	 * question2Writer.close();
	 * 
	 * PrintWriter question3Writer = new
	 * PrintWriter("../questionnaire/pages/question3.html"); String sQuestion3 =
	 * headerQuestion + // "<body value=\"3\">\n" + //
	 * "\t<div class=\"container\">\n" + // "\t\t<div class=\"informations\">\n"
	 * + //
	 ...
	 * "\t\t\t\t\tprogressFill.style.width = `${widthPercentage}%`;\n" + //
	 * "\t\t\t\t}\n" + // "\t\t\t});\n" + // "\t\t});\n" + // "\t</script>\n" +
	 * // "</body>\n" + // "</html>"; question3Writer.println(sQuestion3);
	 * question3Writer.close();
	 * 
	 * PrintWriter question4Writer = new
	 * PrintWriter("../questionnaire/pages/question4.html"); String sQuestion4 =
	 * headerQuestion + // "<body value=\"4\">\n" + //
	 ...
	 * "\t\t\t\tprogressFill.style.width = `${widthPercentage}%`;\n" + //
	 * "\t\t\t\t}\n" + // "\t\t\t});\n" + // "\t\t});\n" + // "\t</script>\n" +
	 * // "</body>\n" + // "</html>"; question4Writer.println(sQuestion4);
	 * question4Writer.close();
	 * 
	 * // Create and write to script files
	 * 
	 * PrintWriter indexJsWriter = new
	 * PrintWriter("../questionnaire/script/index.js");
	 * indexJsWriter.println("// TODO"); indexJsWriter.close();
	 * 
	 * PrintWriter popupJsWriter = new
	 * PrintWriter("../questionnaire/script/popup.js"); String sPopup =
	 ...
	 * "\t\t\tpopup.style.display = 'none';\n" + // "\t\t}\n" + // "\t});\n" +
	 * // "});"; popupJsWriter.println(sPopup); popupJsWriter.close();
	 * 
	 * 
	 * 
